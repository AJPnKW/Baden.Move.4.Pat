...
- detailed logistics
- vendor paperwork and quotes
- raw photos and paperwork images
- sensitive support and service coordination details
- internal QA and validation artifacts with personal context
...
1. [Project Skinny](Docs/01-project-skinny.md)
2. [Context And Constraints](Docs/02-context-and-constraints.md)
3. [Phase Plan](Docs/03-phase-plan.md)
4. [Decision Log](Docs/04-decision-log.md)
5. [Issue Log](Docs/05-issue-log.md)
